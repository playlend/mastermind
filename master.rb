class Game
	...
	def create_pattern
		print "Please, enter 1 if you wish to create a code, or 2 if you want computer to create one: "
		@human_or_computer = gets.chomp
		@human_or_computer = @human_or_computer.to_i
		@code = []
